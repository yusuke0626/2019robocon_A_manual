...
int main(void){
	...
	constexpr int RIGHT_UP_T_ARM_LIMIT   = 12;//12
	constexpr int RIGHT_DOWN_T_ARM_LIMIT = 16;//16
	constexpr int LEFT_UP_T_ARM_LIMIT    = 11;//11
	constexpr int LEFT_DOWN_T_ARM_LIMIT  = 22;//22
