    ...
    UPDATELOOP(controller, !(controller.button(RPDS3::START) && controller.button(RPDS3::RIGHT))){
        ...
        UPDATELOOP(controller, sleep_flag == false){
            ...
            switch(led_lightning_mode){
                case 1:
                    ms.send(TAPE_LED_ARD_NUM,10,);
                    led_count = 0;
                    break;
                case 2:
                    ms.send(TAPE_LED_ARD_NUM,20,);
                    ++led_count;
                    break;
                case 3:
                    ms.send(TAPE_LED_ARD_NUM,30,);
                    ++led_count;
                    break;
                case 4:
                    ms.send(TAPE_LED_ARD_NUM,40,);
                    ++led_count;
                    break;
                case 5:
                    ms.send(TAPE_LED_ARD_NUM,50,);
                    ++led_count;
                    break;
                case 6:
                    ms.send(TAPE_LED_ARD_NUM,60,);
                    ++led_count;
                    break;
                case 7:
                    ms.send(TAPE_LED_ARD_NUM,70,);
                    ++led_count;
                    break;
                case 8:
                    ms.send(TAPE_LED_ARD_NUM,80,);
                    ++led_count;
                    break;
                case 9:
                    ms.send(TAPE_LED_ARD_NUM,90,);
                    ++led_count;
                    break;
                case 10:
                    ms.send(TAPE_LED_ARD_NUM,100,);
                    ++led_count;
                    break;
                case 11:
                    ms.send(TAPE_LED_ARD_NUM,110,);
                    ++led_count;
                    break;
                case 12:
                    ms.send(TAPE_LED_ARD_NUM,120,);
                    ++led_count;
                    break;
            }
